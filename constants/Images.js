...
const TherapistsBackground = require("../assets/imgs/register-bg.png");
const Pro = require("../assets/imgs/getPro-bg.png");
const ArgonLogo = require("../assets/imgs/argonlogo.png");
const iOSLogo = require("../assets/imgs/ios.png");
const androidLogo = require("../assets/imgs/android.png");
const bootstrapLogo = require("../assets/imgs/bootstrap.png");
// internet imgs

const ProfilePicture = 'https://images.unsplash.com/photo-1588862081167-d5b98006637e?fit=crop&w=1650&q=80';
