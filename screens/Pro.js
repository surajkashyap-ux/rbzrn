        ...
        <Block flex>
          ...
          <Block space="between" style={styles.padded}>
            <Block>
              ...
              <Block >
                <Block>
                  <Text color="white" size={60}>Visit</Text>
                </Block>
                <Block>
                  <Text color="white" size={60}>RBZ</Text>
                </Block>
                <Block row>
                  <Text color="white" size={60}>Git</Text>
                  <Block middle style={styles.pro}>
                    <Text size={16} color="white">Repository</Text>
                  </Block>
                </Block>
              </Block>
              <Text size={16} color='rgba(255,255,255,0.6)' style={{ marginTop: 35 }}>
                RBZ by Suraj Kashyap
              </Text>
              ...
              <Button
                ...
                onPress={() => Linking.openURL('').catch((err) => console.error('An error occurred', err))}>
                <Text bold color={theme.COLORS.WHITE}>VISIT NOW</Text>
              </Button>
            </Block>
          </Block>
        </Block>
